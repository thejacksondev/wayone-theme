  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12">
        <p class="footer-logo"><strong><a href="<?php echo home_url(); ?>">Wayone</a></strong></p>
      </div>
      <div class="col-xs-12 col-sm-12">
            ...
            <a href="#4-section">
              <svg style="max-width: 22px;" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <path d="M12 15.5C13.933 15.5 15.5 13.933 15.5 12C15.5 10.067 13.933 8.5 12 8.5C10.067 8.5 8.5 10.067 8.5 12C8.5 13.933 10.067 15.5 12 15.5Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  <path d="M17.6361 7H17.6477" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                </g>
              </svg>
            </a>
          </li>
      ...
      <div class="col-xs-12 col-sm-12">
        <p class="footer-text">
          <span class="copyright">© <?php echo date('Y'); ?> Wayone.</span>
